          ...
          <div className="flex items-center gap-8 lg:gap-16">
            ...
            <div className="hidden lg:flex items-center w-full max-w-md relative group">
              ...
              <input
                ...
                className="block w-full pl-12 pr-4 py-2.5 border border-white/10 rounded-full leading-5 bg-white/5 text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-eclipse-green focus:border-eclipse-green sm:text-sm transition-all duration-300 shadow-[inset_0_2px_4px_rgba(0,0,0,0.2)]"
              />
            </div>
          </div>
