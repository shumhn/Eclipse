      ...
      <div className="relative">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex items-center gap-3 text-xs font-mono bg-white/5 px-4 py-2 rounded-full border border-white/10 text-gray-300">
            ...
            <span className="flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-poly-green shadow-[0_0_8px_rgba(43,168,89,0.8)]" />
          ...
          <div className="absolute right-0 top-full mt-2 w-72 bg-[#030608]/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl z-50 overflow-hidden">
            ...
            <div className="p-4 border-b border-poly-border">
              <div className="flex items-center justify-between mb-3">
                <span className="text-sm font-bold text-poly-text-main">Balances (Devnet)</span>
                <button
                  onClick={fetchBalances}
                  disabled={balances.loading}
                  className="p-1 hover:bg-white/10 rounded-lg text-poly-text-muted"
                >
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-poly-text-muted text-sm flex items-center gap-2">
                    <span className="w-3 h-3 rounded-full bg-gradient-to-r from-purple-500 to-blue-500" />
                    SOL
                  </span>
                  <span className="font-medium text-poly-text-main">{balances.sol.toFixed(4)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-poly-text-muted text-sm flex items-center gap-2">
                  ...
                  <span className="font-medium text-poly-text-main">{balances.usdc.toFixed(2)}</span>
                </div>
              </div>
            </div>

            {/* Shielded USDC Section */}
            <div className="p-4 border-b border-poly-border bg-poly-green/5">
              <div className="flex items-center gap-2 mb-2">
                <Zap className="w-4 h-4 text-poly-green" />
                <span className="text-sm font-bold text-poly-text-main">Shielded USDC</span>
              </div>
              {balances.shieldedUsdc !== null ? (
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-poly-text-muted text-xs flex items-center gap-1">
                      MagicBlock TEE
                    </span>
                  ...
                  <p className="text-xs text-poly-text-muted">
                    Trade privately with 0 latency on Ephemeral Rollups.
                  </p>
                </div>
              ) : (
                <div className="text-xs text-poly-text-muted">
                  <p>No Shielded USDC available.</p>
                  <p className="mt-1 text-poly-green">Deposit USDC to start trading privately.</p>
                </div>
              )}
            </div>
            ...
            {/* Faucet Links */}
            <div className="p-4">
              <span className="text-xs font-bold text-poly-text-muted uppercase mb-2 block">Get Devnet Tokens</span>
              <div className="space-y-2">
                <a
                  href="https://faucet.solana.com/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 p-2 rounded-lg hover:bg-white/5 text-sm transition-colors text-poly-text-main"
                >
                  <Coins className="w-4 h-4 text-purple-500" />
                  <span>SOL Faucet</span>
                  <ExternalLink className="w-3 h-3 ml-auto text-poly-text-muted" />
                </a>
                <a
            ...
            <div className="p-4 pt-0">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 p-2 rounded-lg bg-white/5 hover:bg-white/10 text-sm transition-colors text-poly-text-main"
              >
