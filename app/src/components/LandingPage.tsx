        ...
        <div className="w-full flex justify-center mt-16 max-w-5xl mx-auto">
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 text-lg md:text-xl font-light text-[#E0E0E0] text-left">
            {[
              ...
              >
                <div className="w-12 h-12 rounded-full bg-eclipse-green/10 flex items-center justify-center shrink-0 group-hover:bg-eclipse-green/20 group-hover:scale-110 transition-all duration-300">
                  <Icon className="w-5 h-5 text-eclipse-green" />
                </div>
    ...
    <div className="max-w-6xl mx-auto relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
        {[
          ...
          <div key={i} className="p-10 rounded-[2rem] bg-gradient-to-b from-white/[0.04] to-transparent border border-white/5 hover:border-eclipse-green/30 transition-all duration-500 group">
            <div className="w-16 h-16 rounded-2xl bg-white/5 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
              <feat.icon className="w-8 h-8 text-eclipse-green" />
            </div>
...
const HowItWorks = () => (
  <section className="py-32 px-6 md:px-12 bg-[#020406] text-white relative overflow-hidden">
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-eclipse-green/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="space-y-16 lg:space-y-24">
        {[
          ...
          <div key={i} className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-16 group">
            <div className="text-7xl lg:text-8xl font-light text-white/5 group-hover:text-eclipse-green/20 transition-colors duration-500 w-32 shrink-0">
              {item.step}
            </div>
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-white/10 to-transparent border border-white/10 flex items-center justify-center shrink-0 group-hover:border-eclipse-green/50 transition-colors duration-500">
