/**
 * MagicBlock Ephemeral Rollup Client for Prediction Markets
 *
 * Replaces the old Inco/DAC privacy layer with MagicBlock's TEE-backed
 * Ephemeral Rollups.  Positions are hidden inside the rollup until the
 * market resolves, then committed back to Solana L1.
 *
 * Reference:  expensee-magicblock/lib/magicblock-api.ts
 */
